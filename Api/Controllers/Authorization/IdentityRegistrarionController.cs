...
namespace Api.Controllers.Authorization
{
    ...
    public class IdentityRegistrationController : ControllerBase
    {
        ...
        public IdentityRegistrationController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IMailService mailService)
        {
        ...
        public async Task<IActionResult> Register([FromForm] RegisterRequest request)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var callbackUrl = Url.Action("ConfirmEmail", "IdentityRegistration", new { userId = user.Id, token }, Request.Scheme);
                ...
                return Ok(new { msg = $"Welcome {request.Name}, your account successfully registerd!\nWe sent email verification code at {request.Email}", url = callbackUrl });
            }
            else
            {
